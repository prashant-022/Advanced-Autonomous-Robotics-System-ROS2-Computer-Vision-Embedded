...
class IMUNode(Node):
    ...
    def calibrate(self):
        ...
        self.gx_off = gx_off / 500
        self.gy_off = gy_off / 500
        self.gz_off = gz_off / 500
    ...
    def loop(self):
        ...
        gyro_angle = self.angle + math.radians(gx) * dt
        self.angle = self.alpha * gyro_angle + (1 - self.alpha) * acc_angle
        ...
        # Simple orientation (only roll)
        q = tf_transformations.quaternion_from_euler(self.angle, 0, 0)
